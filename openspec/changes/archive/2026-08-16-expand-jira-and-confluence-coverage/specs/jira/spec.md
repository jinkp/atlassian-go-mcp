...
Phase 1 of `expand-jira-and-confluence-coverage`. Adds 7 tools (4 read, 3 write) to the existing jira module. All tools MUST be reachable from MCP, CLI (`atlassian jira …`), and REST (`/jira/*`) surfaces.
